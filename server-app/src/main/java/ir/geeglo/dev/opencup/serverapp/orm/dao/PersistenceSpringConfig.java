package ir.geeglo.dev.opencup.serverapp.orm.dao;
...
@Configuration
@EnableJpaRepositories(basePackages = "ir.geeglo.dev.opencup.serverapp.orm.entity")
...
public class PersistenceSpringConfig {
    ...
    String getDatabasePlatformName() {
        ...
        if(databasePlatformName.equalsIgnoreCase("postgresql"))
            return "org.eclipse.persistence.platform.database.PostgreSQLPlatform";
        return null;
    }
